...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        //attack lvl
        System.out.print("Enter your attack level (1-" + tempPokemon.hitPoints + "): ");
        tempPokemon.attackLevel = myScan.nextInt();
        //check for bad inputs
        while (tempPokemon.attackLevel < 1 || tempPokemon.attackLevel > tempPokemon.hitPoints - 1) {
            System.out.print("Sorry. The attack level must be between 1 and " + tempPokemon.hitPoints + ": ");
            tempPokemon.attackLevel = myScan.nextInt();
        }
        //defense lvl
        int remainingPoints = tempPokemon.hitPoints - tempPokemon.attackLevel;
        System.out.print("Enter your defense level (1-" + remainingPoints + "): ");
        tempPokemon.defenseLevel = myScan.nextInt();
        //check for bad inputs
        while (tempPokemon.defenseLevel < 1 || tempPokemon.defenseLevel > remainingPoints) {
